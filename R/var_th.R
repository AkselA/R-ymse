...
#' 
#' Use Calculate the theoretical variance of \code{base} probability distributions
#' 
#' @param p a named vector of parameter values, or a single unnamed numeric
#' if only one parameter. Use a data.frame with appropriately named columns
#' to calculate several variances of the same distribution.
#' @param distribution the name of the distribution to calculate the variance of
#' 
#' @details
#' The parameters and their names are the same as used in their respective 
#' density function. In some cases, like gamma, (negative) binomial etc.
#' more than one convention is followed.
#' 
